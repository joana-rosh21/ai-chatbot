...
- Adjustable temperature and system prompt
- Public shareable link via Gradio
...
- gradio
## Sample Output
See [Reference_output.pdf](./Reference_output.pdf) for a sample conversation demonstrating the chatbot's capabilities.
